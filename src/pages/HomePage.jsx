...
export default function HomePage() {
  ...
  useEffect(() => {
    document.title = "Home | Tiny Bloom"
  }, [])
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="h-16 flex items-center justify-between">
            <a href="#top" className="flex items-center gap-3">
              <img src={logo} alt="Tiny Bloom" className="h-10 w-10 rounded-xl object-cover shadow-sm" />
              <div>
                <div className="text-sm font-extrabold text-slate-900 dark:text-white">Tiny Bloom</div>
            ...
            <div className="flex items-center gap-2">
              ...
              <Link to="/login?force=1" className="inline-flex items-center justify-center rounded-full bg-rose-600 dark:bg-slate-900 px-4 py-2 text-sm font-semibold text-white hover:bg-rose-700 dark:hover:bg-slate-800 transition-colors shadow-sm">
                Admin Login
              </Link>
            </div>
          </div>
          ...
          <div className="mt-8 grid lg:grid-cols-3 gap-4">
            ...
            <div className="rounded-3xl border border-slate-200/70 dark:border-slate-700 bg-white dark:bg-slate-900 p-6 shadow-sm">
              ...
              <div className="mt-6 rounded-2xl bg-slate-50 dark:bg-slate-800 border border-slate-200/60 dark:border-slate-700 p-4">
                ...
                <Link to="/login?force=1" className="mt-3 inline-flex items-center justify-center rounded-xl bg-rose-600 dark:bg-slate-900 px-4 py-2.5 text-sm font-semibold text-white hover:bg-rose-700 dark:hover:bg-slate-800 transition-colors w-full">
                  Go to Login
                </Link>
              </div>
            </div>
      ...
      <footer className="border-t border-slate-200/60 dark:border-slate-800 bg-white dark:bg-slate-900">
        <div className="max-w-6xl mx-auto px-4 py-6 flex flex-col sm:flex-row items-center justify-between gap-3">
          <div className="text-xs text-slate-500 dark:text-slate-400">
            <div>© {new Date().getFullYear()} Tiny Bloom. All rights reserved.</div>

...
function PrintDocument({ report, columns, rows, summary, filters, generatedBy }) {
  ...
  return <div id="finance-report-print" className="bg-white p-6 text-slate-900">
    <header className="mb-5 flex items-center justify-between border-b-2 border-emerald-700 pb-4">
      <div className="flex items-center gap-4"><img src={logo} className="h-16 w-16 rounded object-cover" alt="Company logo"/><div><div className="text-2xl font-black">Tiny Bloom</div><div className="text-sm">Wholesale Management System â€¢ Sri Lanka</div></div></div>
    ...
    <footer className="mt-4 border-t pt-2 text-center text-[10px] text-slate-500">Generated from live financial records â€¢ Tiny Bloom Finance Reports</footer>
  </div>
}

...
export default function LoginPage() {
  ...
  useEffect(() => {
    document.title = "Login | Tiny Bloom"
  }, [])
    ...
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="mt-4 text-2xl font-bold text-slate-900 dark:text-white">Tiny Bloom</h1>
        ...
        <div className="bg-white dark:bg-slate-900 border border-slate-200/60 dark:border-slate-700 rounded-xl shadow-sm p-8">
          ...
          <form className="mt-6 space-y-4" onSubmit={onSubmit}>
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full rounded-lg bg-rose-600 dark:bg-slate-900 text-white py-2.5 text-sm font-medium hover:bg-rose-700 dark:hover:bg-slate-800 disabled:opacity-50 transition-colors shadow-sm"
            >
